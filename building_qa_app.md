...
- **Chunk**
  - `id`: STRING Available options: ['d66006059fd78d63f3df90cc1059639a', '0e3dcb4502853979d12357690a95ec17', ...]
  - `text`: STRING Available options: ['How many artists are there?', 'Which actors played in the movie Casino?', ...]
  - `question`: STRING Available options: ['How many artists are there?', 'Which actors played in the movie Casino?', ...]
  - `query`: STRING Available options: ['MATCH (a:Person)-[:ACTED_IN]->(:Movie) RETURN coun', ...]
...
We need to add a step that executes the given Cypher statement. If no results are returned, we should handle this scenario, as leaving the context empty can sometimes lead to LLM hallucinations.
